...
http://docs.jboss.org/jbpm/v6.4/
http://docs.jboss.org/jbpm/release/6.4.0.Final/jbpm-docs/html/

jbpm-6.4.0.Final-examples
jbpm-6.0.0.CR2-docs  还是老的
jbpm-installer\sample\evaluation 的示例可以导入eclipse中去


lib/jboss-wildfly-8.2.1.Final.zip	 (JBoss AS 的新名字)
lib/org.drools.updatesite-6.4.0.Final.zip  可用于eclipse-4.5.2 (取消JBoss Runtime Drools Detector Developer 依赖org.jboss.tools.common.core 找不到 )
lib/jbpm-6.4.0.Final-bin.zip 解压 ,eclipse->preference ->jBPM ->installed jBPM Runtimes->Add... -> Create a new jBPM Runtime 目录指向即可
...
ant install.dashboard.into.jboss   安装 dashboard
就可以用  http://localhost:8080/dashbuilder   admin/admin
