...
<listOptionValue builtIn="false" value="/usr/include/gtk-4.0"/>
...
<listOptionValue builtIn="false" value="/usr/include/sysprof-4"/>
...
<listOptionValue builtIn="false" value="/usr/include/graphene-1.0"/>
<listOptionValue builtIn="false" value="/usr/lib64/graphene-1.0/include"/>
<listOptionValue builtIn="false" value="/usr/include/gio-unix-2.0"/>

  -pthread -mfpmath=sse -msse -msse2  这几下目录测试还不用加
 

<listOptionValue builtIn="false" value="gtk-4"/>
...
<listOptionValue builtIn="false" value="graphene-1.0"/>
...
gtk4-widget-factory		所有的组件界面的演示
